...
def generate_launch_description():
    ...
    stereo_calib_file_path = os.path.join(
        get_package_share_directory("hobot_s316_cam"), "config", "stereo_8_1.yaml"
    )
    ...
    # s316双目相机
    s316_cam_node = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory("hobot_s316_cam"),
                "launch/s316_cam_node.launch.py",
            )
        )
    )
